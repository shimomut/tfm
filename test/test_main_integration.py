...
class MockFileManager:
    ...
    def is_key_for_action(self, key, action):
        """Check if a key matches a configured action (original method)."""
...
class TestMainIntegration(unittest.TestCase):
    ...
    def test_key_binding_without_selection(self):
        ...
        self.assertTrue(self.file_manager.is_key_for_action(ord('q'), 'quit'))
        self.assertTrue(self.file_manager.is_key_for_action_with_selection(ord('q'), 'quit'))
        
        self.assertTrue(self.file_manager.is_key_for_action(ord('?'), 'help'))
        self.assertTrue(self.file_manager.is_key_for_action_with_selection(ord('?'), 'help'))
        
        # Actions that require selection - should not be available
        self.assertTrue(self.file_manager.is_key_for_action(ord('c'), 'copy_files'))  # Key is bound
        self.assertFalse(self.file_manager.is_key_for_action_with_selection(ord('c'), 'copy_files'))  # But not available
        
        self.assertTrue(self.file_manager.is_key_for_action(ord('k'), 'delete_files'))  # Key is bound
        self.assertFalse(self.file_manager.is_key_for_action_with_selection(ord('k'), 'delete_files'))  # But not available
    ...
    def test_key_binding_with_selection(self):
        ...
        self.assertTrue(self.file_manager.is_key_for_action(ord('c'), 'copy_files'))  # Key is bound
        self.assertTrue(self.file_manager.is_key_for_action_with_selection(ord('c'), 'copy_files'))  # And available
        
        self.assertTrue(self.file_manager.is_key_for_action(ord('k'), 'delete_files'))  # Key is bound
        self.assertTrue(self.file_manager.is_key_for_action_with_selection(ord('k'), 'delete_files'))  # And available
    ...
    def test_different_keys_same_action(self):
        ...
        self.assertFalse(self.file_manager.is_key_for_action_with_selection(ord('c'), 'copy_files'))
        self.assertFalse(self.file_manager.is_key_for_action_with_selection(ord('C'), 'copy_files'))
        ...
        self.assertTrue(self.file_manager.is_key_for_action_with_selection(ord('c'), 'copy_files'))
        self.assertTrue(self.file_manager.is_key_for_action_with_selection(ord('C'), 'copy_files'))
    ...
    def test_non_printable_keys(self):
        ...
        self.assertFalse(self.file_manager.is_key_for_action_with_selection(27, 'quit'))  # ESC
        
        self.assertFalse(self.file_manager.is_key_for_action(259, 'quit'))  # Up arrow
        self.assertFalse(self.file_manager.is_key_for_action_with_selection(259, 'quit'))  # Up arrow
    ...
    def test_unbound_keys(self):
        ...
        self.assertFalse(self.file_manager.is_key_for_action_with_selection(ord('z'), 'copy_files'))
