...
- [x] 1. Create drag gesture detection module
...
- [x] 2. Create drag payload builder module
...
- [x] 3. Create drag session manager module
...
- [x] 4. Checkpoint - Ensure core module tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Extend TTK backend interface for drag-and-drop
...
- [x] 6. Implement CoreGraphics backend drag-and-drop
...
- [x] 7. Implement C++ extension for macOS drag-and-drop
  - Extend `ttk/backends/coregraphics_render.cpp` with native drag support
...
- [x] 8. Implement Curses backend graceful degradation
...
- [x] 10. Integrate drag-and-drop into FileManager
...
- [x] 13. Create demo script for drag-and-drop
