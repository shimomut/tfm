...
- [x]* 1.1 Write unit test for module import
  - Test that `import cpp_renderer` succeeds after build
  - Test that module has expected functions
  - _Requirements: 9.4_

- [x] 2. Implement core data structure parsing
  - [x] 2.1 Implement `parse_grid()` function to convert Python grid to C++ vector
  ...
  - [x] 2.2 Implement `parse_color_pairs()` function to convert Python dict to C++ map
...
- [x] 4. Implement FontCache class
  - [x] 4.1 Implement FontCache constructor and destructor
    - Store base_font reference
    - Initialize cache map
    - Ensure proper cleanup of CTFontRef objects in destructor
    - _Requirements: 4.1, 12.1_

  - [x] 4.2 Implement `get_font()` method
...
- [x] 5. Implement AttributeDictCache class
  - [x] 5.1 Implement AttributeDictCache constructor and destructor
  ...
  - [x] 5.2 Implement `get_attributes()` method
  ...
  - [x] 5.3 Implement metrics methods
...
- [x] 7. Implement RectangleBatcher class
  ...
  - [x] 7.3 Implement `finish_row()` and `get_batches()` methods
...
- [x] 8. Implement coordinate transformation utilities
  - [x] 8.1 Implement `calculate_dirty_cells()` function
    - Convert CGRect to cell coordinates
    - Handle TTK (top-left) to CoreGraphics (bottom-left) transformation
    - Clamp to valid grid bounds
    - _Requirements: 1.4, 2.5_

  - [x] 8.2 Implement `ttk_to_cg_y()` function
...
- [x] 9. Implement background rendering
  - [x] 9.1 Implement `render_backgrounds()` function
  ...
  - [x] 9.2 Implement `draw_batched_backgrounds()` function
...
- [x] 10. Implement character rendering
  - [x] 10.1 Implement `render_characters()` function
    - Iterate through dirty region cells
    - Skip spaces (backgrounds already rendered)
    - Batch consecutive characters with same attributes
    - _Requirements: 3.1, 3.3_

  - [x] 10.2 Implement `draw_character_batch()` function
  ...
  - [x] 10.3 Implement wide character handling
...
- [x] 11. Checkpoint - Verify core rendering
  - Test background and character rendering together
  - Compare output with PyObjC rendering visually
  - Ensure all tests pass, ask the user if questions arise.

- [x] 12. Implement cursor rendering
  - [x] 12.1 Implement `render_cursor()` function
...
- [x] 13. Implement IME marked text rendering
  - [x] 13.1 Implement `render_marked_text()` function
...
- [x] 14. Implement main render_frame() function
  - [x] 14.1 Implement parameter validation
  ...
  - [x] 14.2 Implement rendering pipeline
...
- [x] 15. Implement performance metrics
  - [x] 15.1 Add metrics tracking to Renderer class
    - Track frames_rendered, total_render_time, total_batches
    - Update metrics in render_frame()
    - _Requirements: 10.1, 10.3_

  - [x] 15.2 Implement `get_performance_metrics()` function
    - Calculate averages and rates
    - Return Python dict with metrics
    - _Requirements: 10.4_

  - [x] 15.3 Implement `reset_metrics()` function
...
- [x] 16. Checkpoint - Verify complete C++ implementation
  - Run all unit tests
  - Run integration tests
  - Check for memory leaks with Instruments
  - Ensure all tests pass, ask the user if questions arise.

- [x] 17. Implement backend selector in Python
  - [x] 17.1 Add USE_CPP_RENDERING flag to CoreGraphicsBackend
    - Read from environment variable TTK_USE_CPP_RENDERING
    - Default to False for backward compatibility
    - _Requirements: 7.2, 7.3_

  - [x] 17.2 Implement C++ module import with fallback
    - Try to import cpp_renderer if USE_CPP_RENDERING is True
    - Fall back to PyObjC if import fails
    - Log which implementation is being used
    - _Requirements: 7.4, 7.5_

  - [x] 17.3 Modify TTKView.drawRect_() to use backend selector
...
- [x] 18. Implement visual equivalence testing
  - [x] 18.1 Create test harness for rendering to offscreen buffers
    - Render with PyObjC to CGBitmapContext
    - Render with C++ to CGBitmapContext
    - _Requirements: 13.3_

  - [x] 18.2 Implement pixel comparison function
...
- [x] 19. Checkpoint - Verify integration and compatibility
  - [x] Test backend switching
  - [x] Verify visual equivalence
  - [x] Test with real TFM application
  - [x] Ensure all tests pass
  - _Status: COMPLETE - All 23 C++ rendering backend tests passing_

- [x] 20. Performance benchmarking
  - [x] 20.1 Create benchmark script
    - Measure rendering time for various grid sizes
    - Compare C++ vs PyObjC performance
    - _Requirements: 10.1_

  - [x] 20.2 Profile with Instruments
    - Identify performance bottlenecks
    - Verify cache effectiveness
    - _Requirements: 10.2_

  - [x] 20.3 Document performance results
...
- [x] 21. Documentation
  ...
  - [x] 21.2 Write architecture documentation
    - Explain design decisions
    - Document caching strategies
    - _Requirements: 14.2_

  - [x] 21.3 Write build and installation guide
    - Document build requirements
    - Provide step-by-step instructions
    - _Requirements: 14.3_

  - [x] 21.4 Write troubleshooting guide
