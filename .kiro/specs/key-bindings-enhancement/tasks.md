...
- [x] 1. Implement KeyBindings class core functionality
  - [x] 1.1 Create KeyBindings class in tfm_config.py
  ...
  - [x] 1.2 Implement _parse_key_expression method
  ...
  - [x] 1.3 Implement _keycode_from_string method
  ...
  - [x] 1.4 Implement _build_key_lookup method
...
- [x] 2. Implement KeyBindings matching and lookup methods
  - [x] 2.1 Implement _match_key_event method
  ...
  - [x] 2.4 Implement get_keys_for_action method
  ...
  - [x] 2.5 Implement format_key_for_display method
...
- [x] 4. Integrate KeyBindings into ConfigManager
  - [x] 4.1 Add _key_bindings instance variable to ConfigManager.__init__
    - Initialize to None
    - _Requirements: 4.1_

  - [x] 4.2 Implement get_key_bindings method in ConfigManager
    - Get current config
  ...
  - [x] 4.3 Update reload_config method to clear _key_bindings cache
    - Set self._key_bindings = None
    - _Requirements: 4.1_

  - [x] 4.4 Add public API function find_action_for_event
    - Get key_bindings from config_manager
    - Call key_bindings.find_action_for_event(event, has_selection)
    - Return result
    - _Requirements: 5.1_

  - [x] 4.5 Add public API function get_keys_for_action
    - Get key_bindings from config_manager
    - Call key_bindings.get_keys_for_action(action)
    - Return result
    - _Requirements: 6.1_

  - [x] 4.6 Add public API function format_key_for_display
    - Get key_bindings from config_manager
...
- [x] 5. Update DefaultConfig.KEY_BINDINGS to use new format
  - [x] 5.1 Update KEY_BINDINGS to use KeyCode names directly
  ...
  - [x] 5.2 Add modifier key bindings to KEY_BINDINGS
...
- [x] 7. Update application code to use new API
  - [x] 7.1 Update tfm_main.py to use find_action_for_event
  ...
  - [x] 7.2 Update tfm_pane_manager.py to use find_action_for_event
    - Replace is_input_event_bound_to_with_selection calls
    - Use find_action_for_event instead
    - Update action handling logic
    - _Requirements: 5.1_

  - [x] 7.3 Update help dialog to use get_keys_for_action
  ...
  - [x] 7.4 Update other files that use key binding API
...
- [x] 8. Remove legacy code
  - [x] 8.1 Remove SPECIAL_KEY_MAP from tfm_config.py
    - Delete SPECIAL_KEY_MAP dictionary
    - _Requirements: 8.1, 8.3_

  - [x] 8.2 Remove SPECIAL_KEY_NAMES from tfm_config.py
    - Delete SPECIAL_KEY_NAMES dictionary
    - _Requirements: 8.4_

  - [x] 8.3 Mark old API functions as deprecated
