...
- [x] 1. Discover test files and source files
...
- [x] 4. AI outdated pattern analysis
...
- [x] 5. Execute tests and AI failure diagnosis
...
- [x] 6. AI naming convention analysis
...
- [x] 8. Generate AI-assisted audit report
...
- [x] 9. Review findings and select updates
