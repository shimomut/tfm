...
- [ ] 1. Set up project structure and build system
  - [ ] 1.1 Create macos_app/ directory structure
  ...
  - [ ] 1.2 Create Info.plist template
  ...
  - [ ] 1.3 Create build.sh shell script
...
- [ ] 2. Implement Objective-C launcher main entry point
  - [ ] 2.1 Create main.m with NSApplication initialization
...
- [ ] 3. Implement TFMAppDelegate class
  - [ ] 3.1 Create TFMAppDelegate.h header file
  ...
  - [ ] 3.2 Create TFMAppDelegate.m implementation skeleton
...
- [ ] 5. Implement error handling for Python initialization
  - [ ] 5.1 Add error checking for Python initialization
    - Check PyStatus for exceptions
    - Log error message to console
    - Return NO on failure
    - _Requirements: 1.7, 12.1_

  - [ ] 5.2 Implement error dialog display
    - Create showErrorDialog method
    - Use NSAlert for error display
    - Set alert style to critical
    - _Requirements: 12.4_

  - [ ] 5.3 Handle initialization failure in applicationDidFinishLaunching
...
- [ ] 6. Checkpoint - Ensure Python initialization works
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Implement TFM window launching
  - [ ] 7.1 Create launchNewTFMWindow method
  ...
  - [ ] 7.2 Call Python create_window function
  ...
  - [ ] 7.3 Handle window creation errors
...
- [ ] 8. Implement Dock menu integration
  - [ ] 8.1 Implement applicationDockMenu delegate method
  ...
  - [ ] 8.2 Implement newDocument action method
...
- [ ] 9. Implement multi-window support
  - [ ] 9.1 Add window tracking
    - Create NSMutableArray for tracking windows
    - Initialize array in init method
    - _Requirements: 8.1_

  - [ ] 9.2 Update launchNewTFMWindow to track windows
    - Add window reference to tracking array
    - _Requirements: 8.2_

  - [ ] 9.3 Implement window close handling
...
- [ ] 10. Checkpoint - Ensure window management works
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 11. Create Python integration in tfm_main.py
  - [ ] 11.1 Add create_window function to tfm_main.py
  ...
  - [ ] 11.2 Verify main function preserves command-line usage
...
- [ ] 12. Implement build script compilation and bundling
  - [ ] 12.1 Implement compilation step in build.sh
  ...
  - [ ] 12.2 Implement bundle structure creation in build.sh
  ...
  - [ ] 12.3 Implement resource copying in build.sh
  ...
  - [ ] 12.4 Implement Python.framework embedding in build.sh
  ...
  - [ ] 12.5 Implement Info.plist generation in build.sh
...
- [ ] 13. Implement dependency bundling
  - [ ] 13.1 Create script to collect Python dependencies
  ...
  - [ ] 13.2 Verify PyObjC frameworks are included
...
- [ ] 18. Create documentation
  ...
  - [ ] 18.2 Document Xcode Command Line Tools installation
  ...
  - [ ] 18.3 Document bundle structure
  ...
  - [ ] 18.4 Document customization options
