...
- [ ] 1. Extend KeyCode enum with printable characters
...
- [ ] 2. Implement macOS key mapping system
  - [ ] 2.1 Create MACOS_ANSI_KEY_MAP dictionary
  ...
  - [ ] 2.2 Add keyboard_layout parameter to CoreGraphicsBackend.__init__
  ...
  - [ ] 2.3 Implement _get_key_map method
  ...
  - [ ] 2.4 Update _convert_key_event method
...
- [ ] 4. Implement curses key mapping system
  - [ ] 4.1 Create CURSES_ANSI_KEY_MAP dictionary
  ...
  - [ ] 4.2 Add keyboard_layout parameter to CursesBackend.__init__
    - Accept keyboard_layout parameter (default: 'ANSI')
    - Store layout in instance variable
    - Call _get_key_map to initialize key mapping
    - _Requirements: 3.4, 4.2, 4.3_

  - [ ] 4.3 Implement _get_key_map method
    - Return CURSES_ANSI_KEY_MAP for 'ANSI' layout
    - Raise ValueError for unknown layouts
    - _Requirements: 3.5, 4.1, 4.5_

  - [ ] 4.4 Update _convert_key_event method
...
- [ ] 6. Integration and documentation
  - [ ] 6.1 Update KeyEvent usage examples in docstrings
  ...
  - [ ] 6.2 Add keyboard layout documentation
