...
class InfoDialogHelpers:
    ...
    def show_help_dialog(info_dialog):
        ...
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('cursor_up')} Move cursor up")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('cursor_down')} Move cursor down")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('nav_left')} Left pane: go to parent, Right pane: switch to left pane")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('nav_right')} Right pane: go to parent, Left pane: switch to right pane")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('open_item')} Enter directory or open file")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('go_parent')} Go to parent directory")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('select_all')} Go to first item")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('unselect_all')} Go to last item")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('page_up')} Scroll up by page")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('page_down')} Scroll down by page")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('switch_pane')} Switch active pane")
        help_lines.append("")
        ...
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('select_file_up')} Toggle file selection and move up")
        ...
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('scroll_log_up')} Scroll log up one line")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('scroll_log_down')} Scroll log down one line")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('scroll_log_page_up')} Scroll log up one page (older messages)")
        help_lines.append(f"• {InfoDialogHelpers._format_key_bindings('scroll_log_page_down')} Scroll log down one page (newer messages)")
        help_lines.append("")
